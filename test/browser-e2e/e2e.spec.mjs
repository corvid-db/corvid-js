// test/browser-e2e/e2e.spec.mjs — the navigation/multi-page browser
// tests vitest browser mode cannot express from inside the page
// (docs/OPFS-SPEC.md §8's browser-only additions): persistence across
// a REAL page reload, and the cross-tab single-writer BUSY (a second
// page's openOpfs of a locked name rejects 19).
//

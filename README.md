...
- Engine pin: [`corvid` git dep, tag `v0.3.2`](Cargo.toml) (exact
...
// Phrase search (v0.3.2): consecutive in-order tokens, BM25 scores.
...
engine's ascending key-byte order (the v0.3.2 `map_keys` surface).
